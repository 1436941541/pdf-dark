...
const DESCRIPTION =
  "Leia qualquer PDF em modo escuro direto no seu navegador. Grátis, sem enviar arquivos nem cadastro. Quer guardar? Converta e baixe um PDF escuro permanente.";
