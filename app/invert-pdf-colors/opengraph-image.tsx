...
export default function InvertPdfOpenGraphImage() {
    ...
    (
      ...
      >
        ...
        >
          ...
          <span style={{ color: "#fbbf24" }}>Keep photos natural.</span>
        </div>
        ...
        >
          Free. No upload, no signup. Download a new PDF that stays inverted.
        </div>
      </div>
    ),
    { ...size },
