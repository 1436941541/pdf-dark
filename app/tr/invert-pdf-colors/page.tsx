...
function StructuredData() {
  ...
  const howTo = { "@context": "https://schema.org", "@type": "HowTo", name: "PDF'yi karanlık moda dönüştürme", totalTime: "PT1M", estimatedCost: { "@type": "MonetaryAmount", currency: "USD", value: 0 }, step: ["Temanızı seçin", "PDF'nizi bırakın", "Koyu PDF'yi indirin"].map((name, i) => ({ "@type": "HowToStep", position: i + 1, name })) };
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(app) }} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faq) }} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(howTo) }} /></>;
}
