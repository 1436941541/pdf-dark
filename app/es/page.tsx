      ...
      <main className="flex-1 w-full">
        ...
        >
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="sm:hidden" role="table" aria-label="Comparación de herramientas de PDF en modo oscuro">
              <div
                role="row"
                ...
                {COMPARISON_ROWS.map(([feat, a, b, c]) => (
                  ...
                  >
                    ...
                    <div role="presentation" className="grid grid-cols-3 gap-2 text-center text-base">
                      ...
                      <span role="cell" aria-label={`Extensiones de Chrome: ${b}`}>
                        <Mark v={b} />
                      </span>
                      <span role="cell" aria-label={`Otras herramientas online: ${c}`}>
                        <Mark v={c} />
                      </span>
                    </div>
                  </div>
